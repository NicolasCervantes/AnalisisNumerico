...
"El primer paso es declarar la función que contiene el sistema de ecuaciones, del cual
se encontrarán las soluciones. Tal sistema, puede ser de tamaño n
...
está descrita como -z*e^(z-w)+4z-3, luego se escoje la cantidad de ecuaciones que habrá, se escoge un punto inicial al azar
y por último se soluciona el sistema y se muestra la solución. 
Para este caso habrá 10000 ecuaciones para demostrar la efectividad del método
