...
c) Graﬁque los puntos y el polinomio que ajusta d) Utilice la interpolacio´n de Lagrange y escriba el polinomio interpolante e) Compare su resultado con la serie truncada (modelo teórico), cuál aproximacion es mejor por qué?
