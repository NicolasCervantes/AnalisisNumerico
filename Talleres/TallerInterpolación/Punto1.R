...
#Sean x1,x2,...,xn algunos números diferentes por pares y sean y1,y2,...,yn algunos números, entonces existe un único polinomio P de grado
#(Grado n1) tal que: P(xj) = yj (j=1,....,n).

#Las incógnitas del problema son los coeficientes c0,...,cn1 del polinomio P: (x) = c0 + c1x + ... + c1nx1n = n1j = c0jxj.
